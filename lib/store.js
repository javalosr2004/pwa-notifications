...
// Uses Upstash Redis in production (Redis.fromEnv() reads the env vars that
// Vercel's native Upstash integration injects). With no Upstash env vars it
// falls back to an in-memory map so the app runs locally without a cloud
// account — NOT durable, dev only. Swapping this module for Postgres later
// only touches 3 functions.
const hasUpstash =
